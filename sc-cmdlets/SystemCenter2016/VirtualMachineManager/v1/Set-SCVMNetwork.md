...
ms.date: 12/14/2016
content_git_url: https://github.com/MicrosoftDocs/systemcenter-docs-powershell/blob/master/systemcenter-cmdlets/SystemCenter2016/VirtualMachineManager/v1/Set-SCVMNetwork.md
original_content_git_url: https://github.com/MicrosoftDocs/systemcenter-docs-powershell/blob/master/systemcenter-cmdlets/SystemCenter2016/VirtualMachineManager/v1/Set-SCVMNetwork.md
gitcommit: https://github.com/MicrosoftDocs/systemcenter-docs-powershell/blob/ddd0fefc9adaabb9394eb6c21b33370913d1830d/systemcenter-cmdlets/SystemCenter2016/VirtualMachineManager/v1/Set-SCVMNetwork.md
ms.topic: reference
author: tarameyer
ms.author: cfreeman
...
```
Set-SCVMNetwork [-UserRole <UserRole>] [-VMMServer <ServerConnection>] [-VMNetwork] <VMNetwork>
 [-Name <String>] [-Description <String>] [-Owner <String>] [-PortACL <PortACL>] [-RemovePortACL]
...
### -Description
Specifies a description for a virtual machine network.
...
[New-SCVMNetwork](xref:SystemCenter2016/VirtualMachineManager/v1/New-SCVMNetwork.md)

[Remove-SCVMNetwork](xref:SystemCenter2016/VirtualMachineManager/v1/Remove-SCVMNetwork.md)
