...
schema: 2.0.0
ms.assetid: 9C2868A5-10BE-494C-97EC-986CB5CD7C2C
updated_at: 12/15/2016 4:04 AM
ms.date: 12/15/2016
content_git_url: https://github.com/MicrosoftDocs/systemcenter-docs-powershell/blob/master/systemcenter-cmdlets/SystemCenter2016/VirtualMachineManager/vlatest/Set-SCRunAsAccount.md
original_content_git_url: https://github.com/MicrosoftDocs/systemcenter-docs-powershell/blob/master/systemcenter-cmdlets/SystemCenter2016/VirtualMachineManager/vlatest/Set-SCRunAsAccount.md
gitcommit: https://github.com/MicrosoftDocs/systemcenter-docs-powershell/blob/7df4508c7b907a214e6a8eca76037b06065ef078/systemcenter-cmdlets/SystemCenter2016/VirtualMachineManager/vlatest/Set-SCRunAsAccount.md
ms.topic: reference
author: tarameyer
ms.author: cfreeman
...
```
Set-SCRunAsAccount [-VMMServer <ServerConnection>] [-Name <String>] [-Description <String>]
 [-Credential <PSCredential>] [-Owner <String>] [-UserRole <UserRole>] [-RunAsAccount] <RunAsAccount>
 [-JobGroup <Guid>] [-NoValidation] [-RunAsynchronously] [-PROTipID <Guid>] [-JobVariable <String>]
