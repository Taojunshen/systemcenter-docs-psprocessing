---
Module Name: VirtualMachineManager
Module Guid: 74E7C38D-7CBA-4B86-97BD-B9E250E1171F
Download Help Link: http://go.microsoft.com/fwlink/?LinkId=624081
Help Version: 5.0.0.0
Locale: en-US
ms.assetid: 5C12521B-5D41-4CC7-9F2C-33A32787737D
updated_at: 12/15/2016 4:04 AM
ms.date: 12/15/2016
content_git_url: https://github.com/MicrosoftDocs/systemcenter-docs-powershell/blob/master/systemcenter-cmdlets/SystemCenter2016/VirtualMachineManager/vlatest/VirtualMachineManager.md
original_content_git_url: https://github.com/MicrosoftDocs/systemcenter-docs-powershell/blob/master/systemcenter-cmdlets/SystemCenter2016/VirtualMachineManager/vlatest/VirtualMachineManager.md
gitcommit: https://github.com/MicrosoftDocs/systemcenter-docs-powershell/blob/7df4508c7b907a214e6a8eca76037b06065ef078/systemcenter-cmdlets/SystemCenter2016/VirtualMachineManager/vlatest/VirtualMachineManager.md
uid: SystemCenter2016/VirtualMachineManager/vlatest/VirtualMachineManager.md
ms.topic: conceptual
author: tarameyer
ms.author: cfreeman
...
## Description
This section contains the help topics for the System Center 2016 – Virtual Machine Manager (VMM) cmdlets.

## VirtualMachineManager Cmdlets
### [Add-CloudResource](./Add-CloudResource.md)
Adds a cloud resource to VMM.

### [Add-PROTip](./Add-PROTip.md)
Adds a PRO tip.

### [Add-SCApplicationDeployment](./Add-SCApplicationDeployment.md)
Adds an application to an application profile.

### [Add-SCApplicationHostTemplate](./Add-SCApplicationHostTemplate.md)
Adds an application host template to a service template.

### [Add-SCBGPPeer](./Add-SCBGPPeer.md)
Adds a BFP peer to the router.

### [Add-SCComputerTierTemplate](./Add-SCComputerTierTemplate.md)
Adds a computer tier template to a service template.

### [Add-SCCustomPlacementRule](./Add-SCCustomPlacementRule.md)
Adds a custom placement rule to the placement configuration for a host group.

### [Add-SCFabricRoleResource](./Add-SCFabricRoleResource.md)
Adds a fabric role resource.

### [Add-SCLibraryServer](./Add-SCLibraryServer.md)
Adds a computer as a library server to VMM.

### [Add-SCLibraryShare](./Add-SCLibraryShare.md)
Adds Windows shares on the file system of a library server to the VMM library as library shares.

### [Add-SCLoadBalancer](./Add-SCLoadBalancer.md)
Adds a load balancer to VMM.

### [Add-SCNATConnection](./Add-SCNATConnection.md)
Adds a NAT connection.

### [Add-SCNATRule](./Add-SCNATRule.md)
Adds a NAT rule.

### [Add-SCNetworkConnection](./Add-SCNetworkConnection.md)
Adds a network service connection.

### [Add-SCNetworkGateway](./Add-SCNetworkGateway.md)
Adds a network gateway.

### [Add-SCNetworkRoute](./Add-SCNetworkRoute.md)
Adds a network route to VMM.

### [Add-SCNetworkService](./Add-SCNetworkService.md)
Adds a network service to VMM.

### [Add-SCOperatingSystem](./Add-SCOperatingSystem.md)
...
### [Add-SCPowerOptimizationRange](./Add-SCPowerOptimizationRange.md)
Adds a time range to the power optimization schedule in a dynamic optimization configuration.

### [Add-SCPXEServer](./Add-SCPXEServer.md)
Adds an existing Windows Deployment Services computer to VMM.

### [Add-SCScriptCommand](./Add-SCScriptCommand.md)
Adds a script command to an application profile, application deployment, or host profile.

### [Add-SCServerFeature](./Add-SCServerFeature.md)
Adds an operating system role or feature to a guest operating system profile.

### [Add-SCServicingWindowSubscription](./Add-SCServicingWindowSubscription.md)
Adds a servicing window to a virtual machine, host, or service.

### [Add-SCSQLDeployment](./Add-SCSQLDeployment.md)
Adds a SQL Server deployment to a SQL Server profile.

### [Add-SCSQLScriptCommand](./Add-SCSQLScriptCommand.md)
Adds a SQL Server script to a SQL Server application deployment.

### [Add-SCStorageProvider](./Add-SCStorageProvider.md)
Adds a storage provider to VMM.

### [Add-SCUpdateServer](./Add-SCUpdateServer.md)
Adds a WSUS server to VMM.

### [Add-SCUserRolePermission](./Add-SCUserRolePermission.md)
Adds a permission to a user role.

### [Add-SCVirtualizationManager](./Add-SCVirtualizationManager.md)
Adds a VMware vCenter Server to VMM.

### [Add-SCVirtualSwitchExtensionManager](./Add-SCVirtualSwitchExtensionManager.md)
Adds a virtual switch extension manager to VMM.

### [Add-SCVMHost](./Add-SCVMHost.md)
Adds a computer as a virtual machine host.

### [Add-SCVMHostCluster](./Add-SCVMHostCluster.md)
Adds a Windows Server failover cluster, VMware ESX host cluster, or Citrix XenServer resource pool to VMM.

### [Add-SCVMHostNetworkAdapter](./Add-SCVMHostNetworkAdapter.md)
Adds a physical network adapter on a host managed by VMM to a virtual network.

### [Add-SCVMHostToNetworkController](./Add-SCVMHostToNetworkController.md)
Adds a virtual machine host to a network controller.

### [Add-SCVMMManagedComputer](./Add-SCVMMManagedComputer.md)
Adds a managed computer to VMM.

### [Add-SCVMNetworkGateway](./Add-SCVMNetworkGateway.md)
Adds a virtual machine network gateway to VMM.

### [Add-SCVPNConnection](./Add-SCVPNConnection.md)
Adds a VPN connection to a virtual machine network.

### [Backup-SCVMMServer](./Backup-SCVMMServer.md)
Backs up the Virtual Machine Manager database.

### [Clear-SCPowerOptimizationSchedule](./Clear-SCPowerOptimizationSchedule.md)
Deletes a power optimization time range from a dynamic optimization configuration.

### [Clear-SCPROTip](./Clear-SCPROTip.md)
Dismisses a PRO tip object that is no longer applicable.

### [Compress-SCVirtualDiskDrive](./Compress-SCVirtualDiskDrive.md)
Compresses a dynamically expanding virtual hard.

### [Convert-SCVirtualDiskDrive](./Convert-SCVirtualDiskDrive.md)
...
### [Copy-SCVirtualHardDisk](./Copy-SCVirtualHardDisk.md)
...
### [Get-SCCustomPlacementRule](./Get-SCCustomPlacementRule.md)
Gets the custom placment rules for a placement configuration.

### [Get-SCCustomProperty](./Get-SCCustomProperty.md)
Gets a custom property definition from the VMM database.

### [Get-SCCustomPropertyValue](./Get-SCCustomPropertyValue.md)
Gets a custom property value object.

### [Get-SCCustomResource](./Get-SCCustomResource.md)
Gets a custom resource from the VMM library.

### [Get-SCDependentLibraryResource](./Get-SCDependentLibraryResource.md)
Identifies dependencies between VMM objects.

### [Get-SCDirectoryChildItem](./Get-SCDirectoryChildItem.md)
...
### [Get-SCDriverPackage](./Get-SCDriverPackage.md)
Gets a driver package stored in a VMM library share.

### [Get-SCDynamicOptimizationConfiguration](./Get-SCDynamicOptimizationConfiguration.md)
Gets the dynamic optimization configuration for a host group.

### [Get-SCExtensionUplinkPortProfile](./Get-SCExtensionUplinkPortProfile.md)
Gets an extension uplink port profile.

### [Get-SCFabricRole](./Get-SCFabricRole.md)
Gets a fabric role.

### [Get-SCGuardianConfiguration](./Get-SCGuardianConfiguration.md)
Gets metadata for HGS configured with a VMM server.

### [Get-SCGuestOSProfile](./Get-SCGuestOSProfile.md)
Gets a guest operating system profile object from the VMM library.

### [Get-SCHardwareProfile](./Get-SCHardwareProfile.md)
Gets hardware profile objects from the VMM library.

### [Get-SCHostReserve](./Get-SCHostReserve.md)
Gets the host reserve and placement settings for a host group.

### [Get-SCIPAddress](./Get-SCIPAddress.md)
Gets allocated static and virtual IP addresses.

### [Get-SCISO](./Get-SCISO.md)
Gets ISO files from the VMM library.

### [Get-SCISOConfiguration](./Get-SCISOConfiguration.md)
Gets the ISO configuration for a virtual machine configuration.

### [Get-SCJob](./Get-SCJob.md)
Gets VMM job objects.

### [Get-SCKMSNetworkSetting](./Get-SCKMSNetworkSetting.md)
Gets a KMS network setting.

### [Get-SCLibraryRating](./Get-SCLibraryRating.md)
...
### [Get-SCLibraryServer](./Get-SCLibraryServer.md)
Gets VMM library server objects.

### [Get-SCLibraryShare](./Get-SCLibraryShare.md)
Gets VMM library shares.

### [Get-SCLoadBalancer](./Get-SCLoadBalancer.md)
Gets a load balancer object.

### [Get-SCLoadBalancerConfiguration](./Get-SCLoadBalancerConfiguration.md)
Gets the configuration details for the load balancer that is contained within a computer tier configuration.

### [Get-SCLoadBalancerTemplate](./Get-SCLoadBalancerTemplate.md)
Gets a load balancer template for a service or computer tier template.

### [Get-SCLoadBalancerVIP](./Get-SCLoadBalancerVIP.md)
Gets a load balancer VIP object.

### [Get-SCLoadBalancerVIPMember](./Get-SCLoadBalancerVIPMember.md)
Gets a member of a load balancer VIP.

### [Get-SCLoadBalancerVIPTemplate](./Get-SCLoadBalancerVIPTemplate.md)
Gets a load balancer VIP template.

### [Get-SCLogicalNetwork](./Get-SCLogicalNetwork.md)
Gets a logical network object.

### [Get-SCLogicalNetworkDefinition](./Get-SCLogicalNetworkDefinition.md)
Gets a logical network definition.

### [Get-SCLogicalSwitch](./Get-SCLogicalSwitch.md)
Gets a logical switch.

### [Get-SCLogicalSwitchVirtualNetworkAdapter](./Get-SCLogicalSwitchVirtualNetworkAdapter.md)
Gets a logical switch virtual network adapter.

### [Get-SCMACAddress](./Get-SCMACAddress.md)
Gets allocated MAC addresses.

### [Get-SCMACAddressPool](./Get-SCMACAddressPool.md)
Gets a MAC address pool.

### [Get-SCNATConnection](./Get-SCNATConnection.md)
Gets a NAT connection.

### [Get-SCNativeUplinkPortProfile](./Get-SCNativeUplinkPortProfile.md)
Gets a native uplink port profile.

### [Get-SCNATRule](./Get-SCNATRule.md)
Gets a NAT rule.

### [Get-SCNetworkConnection](./Get-SCNetworkConnection.md)
Gets a network service connection.

### [Get-SCNetworkGateway](./Get-SCNetworkGateway.md)
Gets a network gateway object.

### [Get-SCNetworkRoute](./Get-SCNetworkRoute.md)
Gets a network route.

### [Get-SCNetworkService](./Get-SCNetworkService.md)
Gets a network service.

### [Get-SCNetworkServiceCapabilities](./Get-SCNetworkServiceCapabilities.md)
Gets network service capabilities.

### [Get-SCNetworkServiceCertificateUrl](./Get-SCNetworkServiceCertificateUrl.md)
Gets the URL for a network service certificate.

### [Get-SCNotification](./Get-SCNotification.md)
Gets update notifications for a service template or service instance.

### [Get-SCOperatingSystem](./Get-SCOperatingSystem.md)
Gets valid operating system objects from the VMM database.

### [Get-SCOpsMgrConnection](./Get-SCOpsMgrConnection.md)
Gets the Operations Manager connection object.

### [Get-SCPendingServiceSetting](./Get-SCPendingServiceSetting.md)
Gets the pending service settings for a service that is in a pending service state.

### [Get-SCPerformanceData](./Get-SCPerformanceData.md)
Gets performance data for host groups, clusters, hosts, and virtual machines.

### [Get-SCPhysicalComputerNetworkAdapterProfile](./Get-SCPhysicalComputerNetworkAdapterProfile.md)
Gets a physical computer network adapter object.

### [Get-SCPhysicalComputerProfile](./Get-SCPhysicalComputerProfile.md)
Gets a physical computer profile object.

### [Get-SCPlacementConfiguration](./Get-SCPlacementConfiguration.md)
Gets the placement configuration settings for a host group.

### [Get-SCPortACL](./Get-SCPortACL.md)
Gets a port ACL.

### [Get-SCPortACLRule](./Get-SCPortACLRule.md)
Gets a port ACL rule.

### [Get-SCPortClassification](./Get-SCPortClassification.md)
Gets a port classification.

### [Get-SCPowerOptimizationRange](./Get-SCPowerOptimizationRange.md)
Gets the set of time ranges when power optimization will be used.

### [Get-SCPROMonitor](./Get-SCPROMonitor.md)
Gets a PRO monitor object from Operations Manager.

### [Get-SCPROMonitorConfiguration](./Get-SCPROMonitorConfiguration.md)
Gets a PRO monitor configuration object for a specified scope.

### [Get-SCPROMonitorState](./Get-SCPROMonitorState.md)
Gets the state of a specified PRO monitor on a specific VMM object.

### [Get-SCPROTip](./Get-SCPROTip.md)
Gets PRO tip objects from the VMM database.

### [Get-SCPXEServer](./Get-SCPXEServer.md)
Gets a PXEServer object from the VMM database.

### [Get-SCReplicationGroup](./Get-SCReplicationGroup.md)
Gets a replication group.

### [Get-SCRunAsAccount](./Get-SCRunAsAccount.md)
Gets VMM Run As accounts.

### [Get-SCRunAsAccountConsumer](./Get-SCRunAsAccountConsumer.md)
Gets the Run As account consumer objects for a specified Run As account.

### [Get-SCScript](./Get-SCScript.md)
...
### [Get-SCVMMAccessLicense](./Get-SCVMMAccessLicense.md)
Gets the VMM server license information.

### [Get-SCVMMDRServiceRegistration](./Get-SCVMMDRServiceRegistration.md)
Gets current registration information for Site Recovery provider.

### [Get-SCVMMManagedComputer](./Get-SCVMMManagedComputer.md)
Gets computer objects managed by VMM.

### [Get-SCVMMServer](./Get-SCVMMServer.md)
...
### [Get-SCVMNetwork](./Get-SCVMNetwork.md)
Gets a virtual machine network.

### [Get-SCVMNetworkGateway](./Get-SCVMNetworkGateway.md)
Gets a virtual machine network gateway object.

### [Get-SCVMShieldingData](./Get-SCVMShieldingData.md)
Gets a virtual machine shielding data object.

### [Get-SCVMSubnet](./Get-SCVMSubnet.md)
Gets a virtual machine subnet.

### [Get-SCVMTemplate](./Get-SCVMTemplate.md)
Gets virtual machine template objects from the VMM library.

### [Get-SCVMwareResourcePool](./Get-SCVMwareResourcePool.md)
Gets VMware resource pool objects from the VMM database.

### [Get-SCVMXComputerConfiguration](./Get-SCVMXComputerConfiguration.md)
...
### [Get-SCVolumeSignatureCatalog](./Get-SCVolumeSignatureCatalog.md)
Gets the volume signature catalog information from a template disk.

### [Get-SCVPNConnection](./Get-SCVPNConnection.md)
Gets a VPN connection.

### [Grant-SCIPAddress](./Grant-SCIPAddress.md)
Allocates a static or virtual IP address from a specified address pool.

### [Grant-SCMACAddress](./Grant-SCMACAddress.md)
...
### [Read-SCVirtualizationManager](./Read-SCVirtualizationManager.md)
...
### [Read-SCVirtualMachine](./Read-SCVirtualMachine.md)
...
### [Read-SCVirtualSwitchExtensionManager](./Read-SCVirtualSwitchExtensionManager.md)
Refreshes a virtual switch extension manager.

### [Read-SCVMHost](./Read-SCVMHost.md)
Refreshes virtual machine host properties in the VMM Console.

### [Read-SCVMHostCluster](./Read-SCVMHostCluster.md)
Refreshes host cluster properties in the VMM console.

### [Read-SCVMMManagedComputer](./Read-SCVMMManagedComputer.md)
Refreshes a computer that is managed by VMM.

### [Read-SCVMNetworkGateway](./Read-SCVMNetworkGateway.md)
Refreshes a virtual machine network gateway.

### [Read-SCVPNConnection](./Read-SCVPNConnection.md)
Refreshes a VPN connection.

### [Register-SCStorageFileShare](./Register-SCStorageFileShare.md)
Registers a storage file share with a VM host, cluster, or library server.

### [Register-SCStorageLogicalUnit](./Register-SCStorageLogicalUnit.md)
Associates a logical unit with a host.

### [Register-SCVirtualMachine](./Register-SCVirtualMachine.md)
...
### [Register-SCVMHost](./Register-SCVMHost.md)
Associates a VMware ESX host with VMM as a virtual machine host and specifies credentials to manage the host.

### [Register-SCVMMAccessLicense](./Register-SCVMMAccessLicense.md)
Registers VMM using the provided product key.

### [Register-SCVMMManagedComputer](./Register-SCVMMManagedComputer.md)
Reassociates a managed computer on which VMM agent software is installed with a different VMM management server.

### [Remove-CloudResource](./Remove-CloudResource.md)
Removes a cloud resource from VMM.

### [Remove-CloudResourceExtension](./Remove-CloudResourceExtension.md)
Removes a cloud resource extension from VMM.

### [Remove-CloudService](./Remove-CloudService.md)
Removes a cloud service from VMM.

### [Remove-CloudVMRoleSizeProfile](./Remove-CloudVMRoleSizeProfile.md)
Removes a cloud virtual machine role size profile.

### [Remove-SCApplicationDeployment](./Remove-SCApplicationDeployment.md)
Deletes an application deployment from an application profile.

### [Remove-SCApplicationHostTemplate](./Remove-SCApplicationHostTemplate.md)
Removes an application host template from a service template.

### [Remove-SCApplicationPackage](./Remove-SCApplicationPackage.md)
Removes an application package from the VMM library.

### [Remove-SCApplicationProfile](./Remove-SCApplicationProfile.md)
Deletes an application profile.

### [Remove-SCBaseline](./Remove-SCBaseline.md)
Removes a baseline from VMM.

### [Remove-SCBGPPeer](./Remove-SCBGPPeer.md)
Removes a BGP peer from a router.

### [Remove-SCCapabilityProfile](./Remove-SCCapabilityProfile.md)
Deletes a capability profile from VMM.

### [Remove-SCCloud](./Remove-SCCloud.md)
Deletes a private cloud from VMM.

### [Remove-SCCodeIntegrityPolicy](./Remove-SCCodeIntegrityPolicy.md)
Removes a code integrity policy.

### [Remove-SCComputerTierTemplate](./Remove-SCComputerTierTemplate.md)
Removes a computer tier template from a service template.

### [Remove-SCCustomPlacementRule](./Remove-SCCustomPlacementRule.md)
Deletes a custom placement rule from a placement configuration.

### [Remove-SCCustomProperty](./Remove-SCCustomProperty.md)
Removes a custom property definition from the VMM database.

### [Remove-SCCustomPropertyValue](./Remove-SCCustomPropertyValue.md)
Removes the value from a custom property.

### [Remove-SCCustomResource](./Remove-SCCustomResource.md)
Removes a custom resource from the VMM library.

### [Remove-SCDriverPackage](./Remove-SCDriverPackage.md)
Removes a driver package object from the VMM library.

### [Remove-SCFabricRoleResource](./Remove-SCFabricRoleResource.md)
Removes a fabric role resource.

### [Remove-SCGuestOSProfile](./Remove-SCGuestOSProfile.md)
Removes a guest operating system profile object from VMM.

### [Remove-SCHardwareProfile](./Remove-SCHardwareProfile.md)
Removes a hardware profile object from the VMM library.

### [Remove-SCISO](./Remove-SCISO.md)
Removes an ISO file from the VMM library.

### [Remove-SCLibraryServer](./Remove-SCLibraryServer.md)
Removes a library server from VMM.

### [Remove-SCLibraryShare](./Remove-SCLibraryShare.md)
Removes a library share from VMM but does not delete the share from the Windows file system.

### [Remove-SCLoadBalancer](./Remove-SCLoadBalancer.md)
Removes a load balancer from VMM.

### [Remove-SCLoadBalancerTemplate](./Remove-SCLoadBalancerTemplate.md)
Removes a load balancer template from a service template.

### [Remove-SCLoadBalancerVIP](./Remove-SCLoadBalancerVIP.md)
Removes a load balancer VIP from a load balancer.

### [Remove-SCLoadBalancerVIPMember](./Remove-SCLoadBalancerVIPMember.md)
Removes a member from a load balancer VIP.

### [Remove-SCLoadBalancerVIPTemplate](./Remove-SCLoadBalancerVIPTemplate.md)
Deletes a load balancer VIP template from VMM.

### [Remove-SCLogicalNetwork](./Remove-SCLogicalNetwork.md)
Deletes a logical network object.

### [Remove-SCLogicalNetworkDefinition](./Remove-SCLogicalNetworkDefinition.md)
Deletes a logical network definition.

### [Remove-SCLogicalSwitch](./Remove-SCLogicalSwitch.md)
Removes a logical switch.

### [Remove-SCLogicalSwitchVirtualNetworkAdapter](./Remove-SCLogicalSwitchVirtualNetworkAdapter.md)
Removes a virtual network adapter (VNIC) from a logical switch.

### [Remove-SCMACAddressPool](./Remove-SCMACAddressPool.md)
Deletes a MAC address pool.

### [Remove-SCNATConnection](./Remove-SCNATConnection.md)
Removes a NAT connection.

### [Remove-SCNativeUplinkPortProfile](./Remove-SCNativeUplinkPortProfile.md)
Removes a native uplink port profile.

### [Remove-SCNATRule](./Remove-SCNATRule.md)
Removes a NAT rule.

### [Remove-SCNetworkConnection](./Remove-SCNetworkConnection.md)
Removes a network service connection.

### [Remove-SCNetworkGateway](./Remove-SCNetworkGateway.md)
Removes a network gateway object from VMM.

### [Remove-SCNetworkRoute](./Remove-SCNetworkRoute.md)
Removes a network route from VMM.

### [Remove-SCNetworkService](./Remove-SCNetworkService.md)
Removes a network service from VMM.

### [Remove-SCOperatingSystem](./Remove-SCOperatingSystem.md)
Deletes an operating system from an application profile.

### [Remove-SCOpsMgrConnection](./Remove-SCOpsMgrConnection.md)
Removes the Operations Manager connection from VMM.

### [Remove-SCPhysicalComputerNetworkAdapterProfile](./Remove-SCPhysicalComputerNetworkAdapterProfile.md)
Removes a physical computer network adapter profile object from VMM.

### [Remove-SCPhysicalComputerProfile](./Remove-SCPhysicalComputerProfile.md)
Removes a physical computer profile from VMM.

### [Remove-SCPortACL](./Remove-SCPortACL.md)
Removes a port ACL.

### [Remove-SCPortACLRule](./Remove-SCPortACLRule.md)
Removes a port ACL rule.

### [Remove-SCPortClassification](./Remove-SCPortClassification.md)
Removes a port classification.

### [Remove-SCPXEServer](./Remove-SCPXEServer.md)
Removes a PXEServer object from the VMM database.

### [Remove-SCReplicationGroup](./Remove-SCReplicationGroup.md)
Removes a replication group.

### [Remove-SCRunAsAccount](./Remove-SCRunAsAccount.md)
Removes a VMM Run As account.

### [Remove-SCScript](./Remove-SCScript.md)
Removes a script object from VMM.

### [Remove-SCScriptCommand](./Remove-SCScriptCommand.md)
Deletes a script command from an application profile, application deployment, or host profile.

### [Remove-SCServerFeature](./Remove-SCServerFeature.md)
Removes an operating system role or feature from a guest operating system profile.

### [Remove-SCService](./Remove-SCService.md)
Deletes a VMM service and all associated virtual machines.

### [Remove-SCServiceConfiguration](./Remove-SCServiceConfiguration.md)
Deletes a service configuration object from the VMM library.

### [Remove-SCServiceTemplate](./Remove-SCServiceTemplate.md)
Deletes a service template from the VMM library.

### [Remove-SCServicingWindow](./Remove-SCServicingWindow.md)
Removes a servicing window definition from VMM.

### [Remove-SCServicingWindowSubscription](./Remove-SCServicingWindowSubscription.md)
Removes a servicing window from a virtual machine, host, or service.

### [Remove-SCSQLDeployment](./Remove-SCSQLDeployment.md)
Removes a SQL Server deployment from a SQL Server profile.

### [Remove-SCSQLProfile](./Remove-SCSQLProfile.md)
Removes a SQL Server profile.

### [Remove-SCSQLScriptCommand](./Remove-SCSQLScriptCommand.md)
Removes a SQL Server script from an application deployment.

### [Remove-SCSSASConnection](./Remove-SCSSASConnection.md)
Removes the SQL Server Analysis Services connection object from VMM.

### [Remove-SCSSHKey](./Remove-SCSSHKey.md)
Removes a Linux Administrator SSHkey object from VMM.

### [Remove-SCStaticIPAddressPool](./Remove-SCStaticIPAddressPool.md)
Deletes a static IP address pool.

### [Remove-SCStorageClassification](./Remove-SCStorageClassification.md)
Deletes a storage classification object from the VMM database.

### [Remove-SCStorageFabricClassification](./Remove-SCStorageFabricClassification.md)
Removes a Fibre Channel fabric classification from VMM.

### [Remove-SCStorageFileShare](./Remove-SCStorageFileShare.md)
Removes a storage file share from VMM.

### [Remove-SCStorageLogicalUnit](./Remove-SCStorageLogicalUnit.md)
Deletes any associations a logical unit has to a host under VMM management.

### [Remove-SCStoragePool](./Remove-SCStoragePool.md)
Deletes a storage pool and returns capacity.

### [Remove-SCStorageProvider](./Remove-SCStorageProvider.md)
Removes a storage provider from VMM.

### [Remove-SCStorageQoSPolicy](./Remove-SCStorageQoSPolicy.md)
Removes a top-level storage QoS policy from file servers.

### [Remove-SCStorageVolume](./Remove-SCStorageVolume.md)
Deletes an existing Storage Volume.

### [Remove-SCStorageZone](./Remove-SCStorageZone.md)
Removes a zone from a zone set.

### [Remove-SCStorageZoneAlias](./Remove-SCStorageZoneAlias.md)
Removes a Fibre Channel zone alias from a fabric.

### [Remove-SCUpdateServer](./Remove-SCUpdateServer.md)
Removes a WSUS server from VMM.

### [Remove-SCUplinkPortProfileSet](./Remove-SCUplinkPortProfileSet.md)
Removes an uplink port profile set.

### [Remove-SCUserRole](./Remove-SCUserRole.md)
Removes an existing user role.

### [Remove-SCUserRolePermission](./Remove-SCUserRolePermission.md)
Removes a permission from a user role.

### [Remove-SCVirtualDiskDrive](./Remove-SCVirtualDiskDrive.md)
Removes virtual disk drives from a virtual machine or from a virtual machine template.

### [Remove-SCVirtualDVDDrive](./Remove-SCVirtualDVDDrive.md)
Removes a virtual DVD drive object from VMM.

### [Remove-SCVirtualFibreChannelAdapter](./Remove-SCVirtualFibreChannelAdapter.md)
Removes a Virtual Fibre Channel adapter.

### [Remove-SCVirtualFloppyDisk](./Remove-SCVirtualFloppyDisk.md)
Removes a virtual floppy disk object from VMM.

### [Remove-SCVirtualHardDisk](./Remove-SCVirtualHardDisk.md)
Removes a virtual hard disk object from a virtual machine or template, or from the VMM library.

### [Remove-SCVirtualizationManager](./Remove-SCVirtualizationManager.md)
Removes a VMware vCenter Server from VMM.

### [Remove-SCVirtualMachine](./Remove-SCVirtualMachine.md)
Removes a virtual machine object from VMM.

### [Remove-SCVirtualNetwork](./Remove-SCVirtualNetwork.md)
Removes a virtual network from a host managed by VMM.

### [Remove-SCVirtualNetworkAdapter](./Remove-SCVirtualNetworkAdapter.md)
Removes a virtual network adapter object from VMM.

### [Remove-SCVirtualNetworkAdapterNativePortProfile](./Remove-SCVirtualNetworkAdapterNativePortProfile.md)
Removes a virtual network adapter native port profile.

### [Remove-SCVirtualNetworkAdapterPortProfileSet](./Remove-SCVirtualNetworkAdapterPortProfileSet.md)
Removes a virtual network adapter port profile set.

### [Remove-SCVirtualScsiAdapter](./Remove-SCVirtualScsiAdapter.md)
Removes a virtual SCSI adapter object from VMM.

### [Remove-SCVirtualSwitchExtensionManager](./Remove-SCVirtualSwitchExtensionManager.md)
Removes a virtual switch extension manager from VMM.

### [Remove-SCVMCheckpoint](./Remove-SCVMCheckpoint.md)
Removes a virtual machine checkpoint object from the VMM database.

### [Remove-SCVMConfiguration](./Remove-SCVMConfiguration.md)
Removes a virtual machine configuration object from VMM.

### [Remove-SCVMHost](./Remove-SCVMHost.md)
Removes a virtual machine host from VMM.

### [Remove-SCVMHostCluster](./Remove-SCVMHostCluster.md)
Removes a host cluster object from VMM.

### [Remove-SCVMHostFibreChannelVirtualSAN](./Remove-SCVMHostFibreChannelVirtualSAN.md)
Removes a Fibre Channel SAN from Hyper-V.

### [Remove-SCVMHostFromNetworkController](./Remove-SCVMHostFromNetworkController.md)
Removes a virtual machine host from a network controller.

### [Remove-SCVMHostGroup](./Remove-SCVMHostGroup.md)
Removes a host group from VMM.

### [Remove-SCVMHostNetworkAdapter](./Remove-SCVMHostNetworkAdapter.md)
Removes a physical host network adapter object from a virtual network that is configured on a host managed by VMM.

### [Remove-SCVMHostNetworkAdapterProfile](./Remove-SCVMHostNetworkAdapterProfile.md)
Removes a host network adapter profile.

### [Remove-SCVMHostProfile](./Remove-SCVMHostProfile.md)
Removes a host profile object from the VMM database.

### [Remove-SCVMMManagedComputer](./Remove-SCVMMManagedComputer.md)
Removes a computer from VMM management.

### [Remove-SCVMNetwork](./Remove-SCVMNetwork.md)
Removes a virtual machine network.

### [Remove-SCVMNetworkGateway](./Remove-SCVMNetworkGateway.md)
Removes a virtual machine network gateway from VMM.

### [Remove-SCVMShieldingData](./Remove-SCVMShieldingData.md)
Removes a virtual machine shielding data object.

### [Remove-SCVMSubnet](./Remove-SCVMSubnet.md)
Removes a virtual machine subnet.

### [Remove-SCVMTemplate](./Remove-SCVMTemplate.md)
Removes a template object from VMM.

### [Remove-SCVMXComputerConfiguration](./Remove-SCVMXComputerConfiguration.md)
Removes a VMX computer configuration object from VMM.

### [Remove-SCVPNConnection](./Remove-SCVPNConnection.md)
Removes a VPN connection from VMM.

### [Repair-CloudVmRole](./Repair-CloudVmRole.md)
Repairs a cloud virtual machine role.

### [Repair-SCStorageFileShare](./Repair-SCStorageFileShare.md)
Repairs a storage file share.

### [Repair-SCVirtualMachine](./Repair-SCVirtualMachine.md)
Repairs a virtual machine in a failed state.

### [Repair-SCVirtualNetwork](./Repair-SCVirtualNetwork.md)
Repairs a virtual network.

### [Repair-SCVirtualNetworkAdapter](./Repair-SCVirtualNetworkAdapter.md)
Repairs a virtual network adapter.

### [Repair-SCVMHost](./Repair-SCVMHost.md)
Starts remediation steps on a failed host for a set of known failure conditions.

### [Repair-SCVMMDRServiceRegistration](./Repair-SCVMMDRServiceRegistration.md)
Repairs the connection between Virtual Machine Manager server and Azure Site Recovery Manager.

### [Reset-SCPROMonitorState](./Reset-SCPROMonitorState.md)
Resets the state of a specified PRO monitor.

### [Reset-SCVirtualMachine](./Reset-SCVirtualMachine.md)
Resets a virtual machine by powering off the virtual machine and then starting it.

### [Resolve-SCServiceTemplate](./Resolve-SCServiceTemplate.md)
Validates a service template and updates the global settings for the service template.

### [Restart-SCJob](./Restart-SCJob.md)
Restarts a failed or canceled VMM job.

### [Restart-SCVMHost](./Restart-SCVMHost.md)
Restarts a specified host managed by VMM.

### [Restore-SCVMCheckpoint](./Restore-SCVMCheckpoint.md)
Restores a virtual machine to a specified checkpoint.

### [Resume-SCService](./Resume-SCService.md)
Starts a paused VMM service and all virtual machines within that service.

### [Resume-SCVirtualMachine](./Resume-SCVirtualMachine.md)
Resumes paused virtual machines managed by VMM.

### [Revoke-SCIPAddress](./Revoke-SCIPAddress.md)
Returns an allocated IP address to the static IP address pool.

### [Revoke-SCMACAddress](./Revoke-SCMACAddress.md)
Returns an allocated MAC address to the MAC address pool.

### [Revoke-SCResource](./Revoke-SCResource.md)
Revokes access to a resource from a user or user role.

### [Save-SCVirtualMachine](./Save-SCVirtualMachine.md)
Migrates a virtual machine deployed on a host to the VMM library.

### [Set-CloudResourceExtension](./Set-CloudResourceExtension.md)
Updates a cloud resource extension.

### [Set-CloudService](./Set-CloudService.md)
Updates a cloud service.

### [Set-CloudVmRoleScale](./Set-CloudVmRoleScale.md)
Updates a cloud virtual machine role scale.

### [Set-CloudVMRoleSizeProfile](./Set-CloudVMRoleSizeProfile.md)
Updates a cloud VM role size profile.

### [Set-SCApplicationDeployment](./Set-SCApplicationDeployment.md)
Modifies an application deployment.

### [Set-SCApplicationHostTemplate](./Set-SCApplicationHostTemplate.md)
Configures the properties of an application host template that has been added to a service template.

### [Set-SCApplicationPackage](./Set-SCApplicationPackage.md)
Modifies the properties of an application package.

### [Set-SCApplicationProfile](./Set-SCApplicationProfile.md)
Modifies the properties of an application profile.

### [Set-SCApplicationSetting](./Set-SCApplicationSetting.md)
Sets the value of an application setting.

### [Set-SCBaseline](./Set-SCBaseline.md)
Modifies a baseline by adding or removing updates or assignment scopes.

### [Set-SCCapabilityProfile](./Set-SCCapabilityProfile.md)
Modifies the properties of a capability profile.

### [Set-SCCloud](./Set-SCCloud.md)
Changes the properties of a private cloud in VMM.

### [Set-SCCloudCapacity](./Set-SCCloudCapacity.md)
Modifies the cloud capacity settings for a private cloud.

### [Set-SCCodeIntegrityPolicy](./Set-SCCodeIntegrityPolicy.md)
Modifies a code integrity policy.

### [Set-SCComplianceStatus](./Set-SCComplianceStatus.md)
Sets a compliance status object.

### [Set-SCComputerTier](./Set-SCComputerTier.md)
Modifies the properties of a VMM computer tier object.

### [Set-SCComputerTierConfiguration](./Set-SCComputerTierConfiguration.md)
Configures the computer tier configuration object in an undeployed service configuration.

### [Set-SCComputerTierTemplate](./Set-SCComputerTierTemplate.md)
Modifies the properties of a computer tier template.

### [Set-SCCustomPlacementRule](./Set-SCCustomPlacementRule.md)
Modifes a custom placement rule in the placement configuration of a host group.

### [Set-SCCustomProperty](./Set-SCCustomProperty.md)
Modifies the properties of a custom property.

### [Set-SCCustomPropertyValue](./Set-SCCustomPropertyValue.md)
Updates the value of a custom property.

### [Set-SCCustomResource](./Set-SCCustomResource.md)
Sets the properties of a custom resource.

### [Set-SCDriverPackage](./Set-SCDriverPackage.md)
Updates the properties of an existing driver package object.

### [Set-SCDynamicOptimizationConfiguration](./Set-SCDynamicOptimizationConfiguration.md)
Configures dynamic optimization for a host group.

### [Set-SCExternalJob](./Set-SCExternalJob.md)
Updates an existing external job.

### [Set-SCFabricRole](./Set-SCFabricRole.md)
Modifies a fabric role.

### [Set-SCFabricRoleResource](./Set-SCFabricRoleResource.md)
Modifies a fabric role resource.

### [Set-SCGuestInfo](./Set-SCGuestInfo.md)
Sets the value associated with a key for a key/value pair in a guest operating system.

### [Set-SCGuestOSProfile](./Set-SCGuestOSProfile.md)
Changes the properties of a guest operating system profile used in VMM.

### [Set-SCHardwareProfile](./Set-SCHardwareProfile.md)
Changes the properties of a hardware profile used in VMM.

### [Set-SCHostReserve](./Set-SCHostReserve.md)
Modifies the host reserve settings for a host group.

### [Set-SCInternetSCSIHba](./Set-SCInternetSCSIHba.md)
Configures iSCSI initiator sessions and logs the initiator on to the iSCSI storage array.

### [Set-SCIPAddress](./Set-SCIPAddress.md)
Modifies an allocated IP address by assigning the IP address to an object, or updating the IP address description.

### [Set-SCISO](./Set-SCISO.md)
Changes the properties of an ISO object.

### [Set-SCISOConfiguration](./Set-SCISOConfiguration.md)
Updates an ISO configuration in a virtual machine configuration.

### [Set-SCKMSNetworkSetting](./Set-SCKMSNetworkSetting.md)
Sets a KMS network setting.

### [Set-SCLibraryServer](./Set-SCLibraryServer.md)
Sets the properties of a VMM library server.

### [Set-SCLibraryShare](./Set-SCLibraryShare.md)
Changes the description property of a VMM library share object.

### [Set-SCLoadBalancer](./Set-SCLoadBalancer.md)
Modifies the properties of a load balancer.

### [Set-SCLoadBalancerConfiguration](./Set-SCLoadBalancerConfiguration.md)
Updates a load balancer configuration object for a computer tier.

### [Set-SCLoadBalancerTemplate](./Set-SCLoadBalancerTemplate.md)
Configures the properties of a load balancer template.

### [Set-SCLoadBalancerVIPTemplate](./Set-SCLoadBalancerVIPTemplate.md)
Modifies the properties of a load balancer VIP template.

### [Set-SCLogicalNetwork](./Set-SCLogicalNetwork.md)
Changes the properties of a logical network object.

### [Set-SCLogicalNetworkDefinition](./Set-SCLogicalNetworkDefinition.md)
Modifies a logical network definition.

### [Set-SCLogicalSwitch](./Set-SCLogicalSwitch.md)
Updates the properties of a logical switch.

### [Set-SCLogicalSwitchVirtualNetworkAdapter](./Set-SCLogicalSwitchVirtualNetworkAdapter.md)
Commits any changes in settings to an existing virtual network adapter (VNIC) that is connected to a logical switch.

### [Set-SCMACAddressPool](./Set-SCMACAddressPool.md)
Modifies a MAC address pool.

### [Set-SCNATConnection](./Set-SCNATConnection.md)
Updates a NAT connection.

### [Set-SCNativeUplinkPortProfile](./Set-SCNativeUplinkPortProfile.md)
Updates a native uplink port profile.

### [Set-SCNetworkConnection](./Set-SCNetworkConnection.md)
Modifies a network service connection.

### [Set-SCNetworkGateway](./Set-SCNetworkGateway.md)
Sets the properties of a network gateway object.

### [Set-SCNetworkService](./Set-SCNetworkService.md)
Modifies a network service.

### [Set-SCNotification](./Set-SCNotification.md)
Dismisses update notifications for a service template or service instance.

### [Set-SCOpsMgrConnection](./Set-SCOpsMgrConnection.md)
Updates the Operations Manager connection settings.

### [Set-SCPackageMapping](./Set-SCPackageMapping.md)
Updates a package mapping object.

### [Set-SCPhysicalComputerProfile](./Set-SCPhysicalComputerProfile.md)
Modifies a physical computer profile object.

### [Set-SCPlacementConfiguration](./Set-SCPlacementConfiguration.md)
Sets the placement configuration settings for a host group.

### [Set-SCPortACL](./Set-SCPortACL.md)
Modifies a port ACL.

### [Set-SCPortACLRule](./Set-SCPortACLRule.md)
Modifies a port ACL rule.

### [Set-SCPortClassification](./Set-SCPortClassification.md)
Sets the properties of a port classification.

### [Set-SCPROMonitorConfiguration](./Set-SCPROMonitorConfiguration.md)
Updates the properties of a PRO monitor configuration.

### [Set-SCPROTip](./Set-SCPROTip.md)
Sets the status of a PRO tip.

### [Set-SCReplicationGroup](./Set-SCReplicationGroup.md)
Modifies a replication group.

### [Set-SCRunAsAccount](./Set-SCRunAsAccount.md)
Modifies the properties of a Run As account.

### [Set-SCScript](./Set-SCScript.md)
Changes the properties of a script stored in the VMM library.

### [Set-SCScriptCommand](./Set-SCScriptCommand.md)
Configures a script command.

### [Set-SCScriptCommandSetting](./Set-SCScriptCommandSetting.md)
Configures a script command setting.

### [Set-SCService](./Set-SCService.md)
Modifies a VMM service instance.

### [Set-SCServiceConfiguration](./Set-SCServiceConfiguration.md)
Modifies the properties of an undeployed service configuration object stored in the VMM library.

### [Set-SCServiceSetting](./Set-SCServiceSetting.md)
Modifies a service setting.

### [Set-SCServiceTemplate](./Set-SCServiceTemplate.md)
Configures the properties of a service template.

### [Set-SCServicingWindow](./Set-SCServicingWindow.md)
Modifies the properties of a servicing window.

### [Set-SCSQLDeployment](./Set-SCSQLDeployment.md)
Modifies a SQL Server deployment.

### [Set-SCSQLProfile](./Set-SCSQLProfile.md)
Modifies the properties of a SQL Server profile.

### [Set-SCSQLScriptCommand](./Set-SCSQLScriptCommand.md)
Modifies the properties of a SQL Server script.

### [Set-SCSSHKey](./Set-SCSSHKey.md)
Updates the properties of a Linux SSHKey.

### [Set-SCStaticIPAddressPool](./Set-SCStaticIPAddressPool.md)
Modifies a static IP address pool that is associated with one or more hostgroups.

### [Set-SCStorageArray](./Set-SCStorageArray.md)
Modifies the properties of a storage array object.

### [Set-SCStorageClassification](./Set-SCStorageClassification.md)
Modifies the properties of an existing storage classification.

### [Set-SCStorageDisk](./Set-SCStorageDisk.md)
Updates a storage disk object in the VMM database.

### [Set-SCStorageFabric](./Set-SCStorageFabric.md)
Updates a storage Fibre Channel fabric object.

### [Set-SCStorageFabricClassification](./Set-SCStorageFabricClassification.md)
Modifies a Fibre Channel fabric classification.

### [Set-SCStorageFileServer](./Set-SCStorageFileServer.md)
Adds or removes a storage file share from VMM management.

### [Set-SCStorageFileServerNode](./Set-SCStorageFileServerNode.md)
Modifies a file server node.

### [Set-SCStorageFileShare](./Set-SCStorageFileShare.md)
Modifies a storage file share.

### [Set-SCStorageLogicalUnit](./Set-SCStorageLogicalUnit.md)
Updates the metadata of a storage logical unit object.

### [Set-SCStoragePool](./Set-SCStoragePool.md)
Modifies a storage pool object in the VMM database.

### [Set-SCStorageProvider](./Set-SCStorageProvider.md)
Modifies a storage provider object in VMM.

### [Set-SCStorageQoSPolicy](./Set-SCStorageQoSPolicy.md)
Modifies a storage QoS policy on one or more storage file servers.

### [Set-SCStorageVolume](./Set-SCStorageVolume.md)
...
### [Set-SCVirtualFibreChannelAdapter](./Set-SCVirtualFibreChannelAdapter.md)
Modifies a Virtual Fibre Channel adapter.

### [Set-SCVirtualFibreChannelAdapterConfiguration](./Set-SCVirtualFibreChannelAdapterConfiguration.md)
...
### [Set-SCVirtualFloppyDisk](./Set-SCVirtualFloppyDisk.md)
Changes the properties of a virtual floppy disk used in VMM.

### [Set-SCVirtualFloppyDrive](./Set-SCVirtualFloppyDrive.md)
